...
export interface DocumentTemplate { id: string; typeId: string; name: string; subject: string; description?: string; body: string; active: boolean; isDefault?: boolean; createdAt: string; updatedAt: string }
